...
<head>
  ...
  <title>${title}</title>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&subset=vietnamese&family=Merriweather:wght@400;700&display=swap" rel="stylesheet">
  <script>
      window.MathJax = { 
